<?php
$pageTitle = 'Detalle Orden de Salida';
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col">
            <h2><i class="bi bi-arrow-up-circle"></i> Orden de Salida #<?php echo $orden['Id']; ?></h2>
        </div>
        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <table class="table table-sm">
                        ...
                        <tr>
                            <th>Tipo:</th>
                            <td>
                                <span class="badge bg-info"><?php echo $orden['TipoSalida']; ?></span>
                            </td>
                        </tr>
                        <tr>
                            <th>Sucursal:</th>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="/vetalmacen/public/index.php?url=ordenes_salida/cambiarEstado">
                        ...
                        <div class="mb-3">
                            <select class="form-select" name="estado" required>
                                ...
                                <option value="Procesado" <?php echo $orden['Estado'] == 'Procesado' ? 'selected' : ''; ?>>Procesado</option>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-danger"><?php echo number_format($detalle['Cantidad']); ?></span>
                                    </td>
