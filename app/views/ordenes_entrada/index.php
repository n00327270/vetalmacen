...
<div class="container-fluid py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Órdenes de Entrada</li>
        </ol>
    </nav>
    
    <div class="row mb-4">
        <div class="col">
            <h2><i class="bi bi-arrow-down-circle"></i> Órdenes de Entrada</h2>
        </div>
        <div class="col-auto">
            <!-- 🔒 PROTECCIÓN -->
            <?php if (PermisoHelper::tienePermiso('ordenes_entrada/crear')): ?>
            <a href="/vetalmacen/public/index.php?url=ordenes_entrada/crear" class="btn btn-success">
                <i class="bi bi-plus-circle"></i> Nueva Orden de Entrada
            </a>
            <?php endif; ?>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-4 text-muted">
                                ...
                                <p class="mt-2">No hay órdenes de entrada registradas</p>
                            </td>
                        </tr>
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <!-- 🔒 ELIMINAR -->
                                        <?php if (PermisoHelper::tienePermiso('ordenes_entrada/eliminar') && in_array($orden['Estado'], ['Pendiente', 'Cancelado'])): ?>
                                        <button type="button" 
...
function eliminarOrden(id) {
    if (confirm('¿Está seguro de eliminar esta orden de entrada?')) {
        window.location.href = `/vetalmacen/public/index.php?url=ordenes_entrada/eliminar/${id}`;
    }
}
</script>
